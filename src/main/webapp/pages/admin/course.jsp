		 ...
		 <img alt="" src="style/image/courses/${course.id}.jpg">
			...
			<input type="hidden" name="id" value="${course.id }">
				...
				<div class="form-group">
					 ...
					 <input type="file" id="exampleInputFile" multiple="multiple" name="file" accept=".*"/>
					<p class="help-block">
						将封面图片（jpg,png如上传多个图片或多个视频只按照最后一个处理）和视屏文件一起上传或单个上传，视屏文件只支持mp4格式，请转换格式之后在上传，避免客户端播放不了，视频文件上传限制500MB.
					</p>
				</div>
				<c:if test="${course!=null }">
